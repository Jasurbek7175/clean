    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="row mb-4">
                        <a class="btn btn-sm btn-outline-dark mr-3" href="{{ route('posts.edit', ['post'=>$post->id])  }}">O'zgartirish</a>
                        <form action="{{ route('posts.destroy', ['post'=>$post->id])}}" method="POST" onsubmit="return comfirm('Are you sure to delete');">
                            @csrf
                            @method('DELETE')
                    ...
                    <div class="mb-5">
                        <h3 class="mb-4 section-title">{{$post->count()}} Comments</h3>
                        <div class="media mb-4">
                            <img src="/img/user.jpg" alt="Image" class="img-fluid rounded-circle mr-3 mt-1" style="width: 45px;">
                            <div class="media-body">
                                <h6>{{$post->user->name}} <small><i>{{$post->user->created_at}}</i></small></h6>
                            @dd($post)
